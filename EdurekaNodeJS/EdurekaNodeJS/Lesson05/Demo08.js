//configuring Express JS 'Router' with 'Mongoose'
...
var commonRouter =  express.Router();       //import ExpressJs Router
...
app.use(commonRouter);                            //add Router to Express

var port = 3000;

commonRouter.get('/getUserWithRouter',function(req,resp){ //ExpressJs Router
